...
do
    ...
    -- Black / orange design.  This is deliberately separate from the main hub.
    --------------------------------------------------------------------------
    ...
    second.Size = UDim2.fromOffset(205, 255)
    ...
    secondStroke.Color = Color3.fromRGB(255, 125, 20)
    secondStroke.ZIndex = 20

    local secondGlow = Instance.new("UIStroke", second)
    secondGlow.Thickness = 6
    secondGlow.Transparency = 0.78
    secondGlow.Color = Color3.fromRGB(255, 120, 10)
    secondGlow.ZIndex = 19

    local secondGradient = Instance.new("UIGradient", secondStroke)
    secondGradient.Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(60, 25, 5)),
        ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 155, 30)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 230, 200)),
        ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 155, 30)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(60, 25, 5))
    })
    task.spawn(function()
    ...
    secondTitle.Text = "SAE HUB • AUTO STEAL"
    secondTitle.TextColor3 = Color3.fromRGB(255, 230, 200)
    ...
    secondClose.BackgroundColor3 = Color3.fromRGB(55, 30, 5)
    secondClose.BorderSizePixel = 0
    secondClose.Font = Enum.Font.GothamBold
    secondClose.Text = "X"
    secondClose.TextColor3 = Color3.fromRGB(255, 230, 200)
    ...
    eggList.BackgroundColor3 = Color3.fromRGB(255, 230, 200)
    eggList.BackgroundTransparency = 0.15
    eggList.BorderSizePixel = 0
    eggList.ScrollBarThickness = 3
    eggList.ScrollBarImageColor3 = Color3.fromRGB(255, 125, 20)
    ...
    local function setSecondAutoVisual(on)
        ...
        autoStealButton.BackgroundColor3 = autoStealOn
            and Color3.fromRGB(255, 145, 25)
            or Color3.fromRGB(70, 38, 5)
    end
    ...
    local function refreshEggView()
        ...
        if #list == 0 then
            ...
            empty.TextColor3 = Color3.fromRGB(180, 90, 10)
            empty.TextSize = 9
            empty.ZIndex = 22
            return
        end
        ...
        for index, e in ipairs(list) do
            ...
            b.BackgroundColor3 = (selectedUid == tostring(e.uid))
                ...
                or Color3.fromRGB(22, 16, 8)
            b.BorderSizePixel = 0
            b.Font = Enum.Font.GothamBold
            b.Text = describeEgg(e)
            b.TextColor3 = Color3.fromRGB(255, 245, 225)
            b.TextSize = 8
    ...
    secondOpen.TextColor3 = Color3.fromRGB(255, 100, 10)
    ...
    secondOpenStroke.Color = Color3.fromRGB(255, 135, 15)
    secondOpenStroke.ZIndex = 20


    -- ONLY THE AUTO STEAL / SELECTED EGG UI IS SHOWN.
    -- Remove/hide the old first menu if it exists.
    task.defer(function()
        for _, child in ipairs(gui:GetChildren()) do
            if child ~= second and child ~= secondOpen
                and child:IsA("Frame")
                and child.Name ~= "SAEGRR_AutoStealPanel" then
                child.Visible = false
            end
        end
    end)
